# -*- coding: utf-8 -*-
"""
Created on Thu Oct  2 17:35:31 2014
...
if db_is_new:
  ...
  try:
    cursor.execute("CREATE TABLE IF NOT EXISTS valor(hora TEXT NOT NULL, mes TEXT NOT NULL, ano TEXT NOT NULL, temp_ar TEXT, temp_max TEXT, temp_min TEXT, umi TEXT, pluvio TEXT)");
...
for l in range(1, linhas_total):
  ...
  cursor.execute("INSERT INTO valor VALUES(?,?,?,?,?,?,?,?)",(str(hora),str(mes),str(ano),str(temperatura_ar),str(temperatura_max),str(temperatura_min),str(umidade_rel),str(pluvio)))
